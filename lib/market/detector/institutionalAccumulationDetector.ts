// lib/market/detector/institutionalAccumulationDetector.ts
...
주의
- confidence는 기존대로 0~1 normalize 유지
- whaleIntensity SSOT 0~100 변경과 무관하게
  이 detector의 whaleRatio / confidence 체계는 기존 유지
=========================================================== */
