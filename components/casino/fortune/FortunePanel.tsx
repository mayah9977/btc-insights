...
className="fixed bottom-0 left-0 right-0 z-50 bg-black rounded-t-3xl p-5 pb-28 max-h-[85vh] overflow-y-auto"
>
...
whileTap={{ scale: 0.9 }}
onClick={() => setModalOpen(false)}
className="absolute top-0 right-0 text-yellow-400 text-xl font-bold px-3 py-1"
>
✕
</motion.button>
</div>
