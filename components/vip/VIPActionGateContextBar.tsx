...
import ActionGateStatusMobile from '@/components/vip/mobile/ActionGateStatusMobile'
import ActionGateRendererMobile from '@/components/vip/mobile/ActionGateRendererMobile'
...
export default function VIPActionGateContextBar({
  symbol,
  signalType,
  sentence,
}: Props) {
